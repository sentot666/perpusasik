...
<div class="page-header">
    <h1 class="text-3xl font-bold text-slate-800 mb-1"></h1>
    <p>{{ __('Selamat datang,') }} <strong>{{ auth()->user()->name }}</strong> — {{ now()->translatedFormat('l, d F Y') }}</p>
</div>

{{-- ── Stat Cards ─────────────────────────────────────────────────────────── --}}
<div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full lg:w-1/4 w-1/2 px-4">
        <div class="btn-gradient-blue text-white rounded-xl shadow-md overflow-hidden border-none transform transition duration-300 hover:scale-105 mb-4 lg:mb-0">
            <div class="items-center p-6 flex gap-5">
                ...
                <div>
                    ...
                    <div class="stat-label text-white/90 text-sm font-medium">{{ __('Total Judul Buku') }}</div>
                </div>
            </div>
        </div>
    </div>
    <div class="w-full lg:w-1/4 w-1/2 px-4">
        <div class="btn-gradient-green text-white rounded-xl shadow-md overflow-hidden border-none transform transition duration-300 hover:scale-105 mb-4 lg:mb-0">
            <div class="items-center p-6 flex gap-5">
                <div class="stat-icon bg-white/20 text-white rounded-xl flex items-center justify-center w-14 h-14 text-2xl shadow-sm backdrop-blur-sm">
                ...
                <div>
                    ...
                    <div class="stat-label text-white/90 text-sm font-medium">{{ __('Total Anggota') }}</div>
                </div>
            </div>
        </div>
    </div>
    <div class="w-full lg:w-1/4 w-1/2 px-4">
        <div class="btn-gradient-orange text-white rounded-xl shadow-md overflow-hidden border-none transform transition duration-300 hover:scale-105 mb-4 lg:mb-0">
            <div class="items-center p-6 flex gap-5">
                <div class="stat-icon bg-white/20 text-white rounded-xl flex items-center justify-center w-14 h-14 text-2xl shadow-sm backdrop-blur-sm">
                ...
                <div>
                    ...
                    <div class="stat-label text-white/90 text-sm font-medium">{{ __('Sedang Dipinjam') }}</div>
                </div>
            </div>
        </div>
    </div>
    <div class="w-full lg:w-1/4 w-1/2 px-4">
        <div class="btn-gradient-red text-white rounded-xl shadow-md overflow-hidden border-none transform transition duration-300 hover:scale-105 mb-4 lg:mb-0">
            <div class="items-center p-6 flex gap-5">
                <div class="stat-icon bg-white/20 text-white rounded-xl flex items-center justify-center w-14 h-14 text-2xl shadow-sm backdrop-blur-sm">
                ...
                <div>
                    ...
                    <div class="stat-label text-white/90 text-sm font-medium">{{ __('Terlambat') }}</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-full lg:w-1/4 w-1/2 px-4">
        <div class="bg-slate-800 hover:bg-slate-900 text-white rounded-xl shadow-md overflow-hidden border-none transform transition duration-300 hover:scale-105 mb-4 lg:mb-0">
            <div class="items-center p-6 flex gap-5">
                <div class="stat-icon bg-white/20 text-white rounded-xl flex items-center justify-center w-14 h-14 text-2xl shadow-sm backdrop-blur-sm">
                ...
                <div>
                    ...
                    <div class="stat-label text-white/90 text-sm font-medium">{{ __('Total Eksemplar') }}</div>
                </div>
            </div>
        </div>
    </div>
    <div class="w-full lg:w-1/4 w-1/2 px-4">
        <div class="btn-gradient-cyan text-white rounded-xl shadow-md overflow-hidden border-none transform transition duration-300 hover:scale-105 mb-4 lg:mb-0">
            <div class="items-center p-6 flex gap-5">
                <div class="stat-icon bg-white/20 text-white rounded-xl flex items-center justify-center w-14 h-14 text-2xl shadow-sm backdrop-blur-sm">
                ...
                <div>
                    ...
                    <div class="stat-label text-white/90 text-sm font-medium">{{ __('Eksemplar Tersedia') }}</div>
                </div>
            </div>
        </div>
    </div>
    <div class="w-full lg:w-1/4 w-1/2 px-4">
        <div class="btn-gradient-purple text-white rounded-xl shadow-md overflow-hidden border-none transform transition duration-300 hover:scale-105 mb-4 lg:mb-0">
            <div class="items-center p-6 flex gap-5">
                <div class="stat-icon bg-white/20 text-white rounded-xl flex items-center justify-center w-14 h-14 text-2xl shadow-sm backdrop-blur-sm">
                ...
                <div>
                    ...
                    <div class="stat-label text-white/90 text-sm font-medium">{{ __('Pinjam Hari Ini') }}</div>
                </div>
            </div>
        </div>
    </div>
    <div class="w-full lg:w-1/4 w-1/2 px-4">
        <div class="btn-gradient-yellow text-white rounded-xl shadow-md overflow-hidden border-none transform transition duration-300 hover:scale-105 mb-4 lg:mb-0">
            <div class="items-center p-6 flex gap-5">
                <div class="stat-icon bg-white/20 text-white rounded-xl flex items-center justify-center w-14 h-14 text-2xl shadow-sm backdrop-blur-sm">
                ...
                <div>
                    ...
                    <div class="stat-label text-white/90 text-sm font-medium">{{ __('Kembali Hari Ini') }}</div>
                </div>
            </div>
        </div>
    </div>
...
<div class="flex flex-wrap -mx-3">
    ...
    <div class="w-full lg:w-7/12 px-4">
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 h-full overflow-hidden">
            <div class="justify-between items-center px-8 border-b border-slate-200 bg-slate-50 font-medium text-slate-700 flex py-4">
                <span><i class="bi bi-arrow-left-right text-amber-500 mr-2"></i>{{ __('Peminjaman Terkini') }}</span>
                <a href="{{ route('circulations.index') }}" class="inline-flex items-center justify-center gap-1.5 py-1.5 text-xs font-medium rounded-lg text-slate-700 border border-slate-200 border-slate-300 hover:bg-slate-50 transition-colors px-4">{{ __('Lihat Semua') }}</a>
            </div>
            <div class="p-0">
    ...
    <div class="w-full lg:w-5/12 px-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-6">
            <div class="px-8 border-b border-slate-200 bg-slate-50 font-medium text-slate-700 py-4"><i class="bi bi-lightning-charge-fill text-amber-500 mr-2"></i>{{ __('Aksi Cepat') }}</div>
            <div class="p-8">
                <div class="grid gap-2">
                    <a href="{{ route('circulations.loan') }}" class="inline-flex items-center justify-center text-sm font-medium rounded-lg btn-gradient-blue transition-colors text-white gap-2 py-2 px-6">
                        <i class="bi bi-box-arrow-right mr-2"></i>{{ __('Proses Peminjaman') }}
                    </a>
                    <a href="{{ route('circulations.return') }}" class="inline-flex items-center justify-center text-sm font-medium rounded-lg btn-gradient-green transition-colors text-white gap-2 py-2 px-6">
                    ...
                    <a href="{{ route('members.create') }}" class="inline-flex items-center justify-center text-sm font-medium rounded-lg text-indigo-600 border border-slate-200 border-indigo-600 hover:bg-indigo-50 transition-colors gap-2 py-2 px-6">
                        <i class="bi bi-person-plus mr-2"></i>{{ __('Tambah Anggota') }}
                    </a>
                    <a href="{{ route('books.create') }}" class="inline-flex items-center justify-center text-sm font-medium rounded-lg text-slate-700 border border-slate-200 border-slate-300 hover:bg-slate-50 transition-colors gap-2 py-2 px-6">
                        <i class="bi bi-plus-circle mr-2"></i>{{ __('Tambah Buku') }}
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="border-danger bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden" style="border-color:#fee2e2!important">
            <div class="btn-gradient-red text-white px-8 border-b border-slate-200 font-medium py-4">
                <i class="bi bi-exclamation-triangle-fill mr-2"></i>{{ __('Terlambat') }} ({{ $overdueLoans->count() }})
            </div>
            <div class="p-0">
