...
<div x-data="{ showAddModal: false }">
    <div class="page-header flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div class="flex flex-wrap gap-2 w-full sm:w-auto">
            <a href="{{ route('guest-books.export', request()->all()) }}" class="inline-flex items-center justify-center text-xs sm:text-sm font-medium rounded-lg btn-gradient-green text-white transition-colors gap-1.5 py-2 px-4 shadow-sm">
