...
<div class="w-full max-w-[420px] mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
    ...
    <div class="bg-gradient-to-br from-[#2b6cb0] to-[#1e3a5f] px-8 py-10 text-center text-white">
        ...
        <h1 class="text-2xl font-extrabold leading-tight">Buat Password Baru</h1>
        <p class="text-white/70 text-xs mt-1">Sistem Informasi Perpustakaan</p>
    </div>

    <div class="px-8 py-8">
        <p class="text-center text-slate-500 text-sm mb-6">Silakan masukkan password baru untuk akun Anda.</p>
...
document.getElementById('resetForm').addEventListener('submit', function() {
    ...
    btn.innerHTML = '<i class="bi bi-hourglass-split mr-2 animate-spin"></i>Menyimpan...';
    btn.disabled = true;
});
</script>
@endpush
