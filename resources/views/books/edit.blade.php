...
<div class="card">
    <div class="card-header"><i class="bi bi-pencil-square me-2 text-primary"></i>Form Edit Bibliografi</div>
    <div class="card-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="isbn13" class="form-control" value="{{ old('isbn13', $book->isbn13) }}">
                        </div>
                    </div>
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ddc" class="form-control" value="{{ old('ddc', $book->ddc) }}">
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="publication_year" class="form-control" value="{{ old('publication_year', $book->publication_year) }}">
                        </div>
                    </div>
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="place_of_publication" class="form-control" value="{{ old('place_of_publication', $book->place_of_publication) }}">
                        </div>
                        <div class="col-md-6">
                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <textarea name="abstract" class="form-control" rows="3">{{ old('abstract', $book->abstract) }}</textarea>
                    </div>
                </div>
            </div>
